...
<div class="row">
  <div class="col-3 col-s-3 menu">
    <ul>
      ...
      <a href="product.php"><li style="background-color:dimgrey">Products</li></a>
...
while($row=mysqli_fetch_array($run)){
  $cid=$row['cid'];
  ?>
    <a href="details.php?cid=<?php echo $cid; ?>"><div class="col-2 col-s-9 brand" style="background-image: url(images/<?php echo $row['photo']?>); background-size: contain; background-repeat: no-repeat;">
